 ...
 */
#ifndef CONSTRAINTS_MAGNETICCONSTRAINT_HPP
#define CONSTRAINTS_MAGNETICCONSTRAINT_HPP
...
public:
   ...
   */
  virtual void add_energy(const Particle &p, const Utils::Vector3d &dipole,
  ...
  virtual ~MagneticConstraint() = default;
};
